package summativeassesment1;
//A separate class for the players was created to manipulate each player's data in an easier way.
import java.util.*;

public class SummativeAssesment1 {

    public static void main(String[] args) {
        //This will call the initialisation function to start the game
        gameInitialisation();
    }

    public static void gameInitialisation() {
        //It will allow the user to initialise the game or leave. If initialised, board will be created and game will start the rounds and turns
